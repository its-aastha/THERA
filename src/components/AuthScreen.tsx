        ...
        {!isLocalMode ? (
          <div className="space-y-6 py-2 animate-in fade-in duration-200">
            <div className="text-center py-2">
              <h2 className="text-lg font-bold text-slate-800 tracking-tight">Log In</h2>
              <p className="text-xs text-slate-500 mt-1">Access your cloud sync sanctuary securely.</p>
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={loading}
                type="button"
                className="w-full py-3 bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 hover:text-slate-950 font-bold text-sm rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer shadow-xs"
              >
              ...
              <button
                ...
                disabled={loading}
                type="button"
                className="w-full py-3 bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 hover:text-slate-950 font-bold text-sm rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer shadow-xs"
              >
          ...
          <form onSubmit={handleForgotPasswordSubmit} className="space-y-4 animate-in fade-in duration-200">
            ...
            >
              {loading ? (
                ...
                <span>Reset Local Password to '123456'</span>
              )}
            </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {loading ? (
                  ...
                  <span>
                    {isRegistering ? "Create Local Account" : "Access Local Sanctuary"}
                  </span>
                )}
              </button>
            </form>
