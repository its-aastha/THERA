        ...
        <div className="p-4 bg-white border-t border-slate-200">
          <form onSubmit={handleSubmit} className="flex gap-2">
            <input
              ...
              className="flex-1 bg-slate-100 border border-slate-200 text-slate-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-indigo-500/80 focus:bg-[#031311] transition-colors disabled:opacity-50 placeholder-slate-400"
            />
            <button
              type="submit"
