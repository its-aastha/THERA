          ...
          <div className="lg:col-span-4 p-5 bg-white border border-slate-200 shadow-sm rounded-2xl space-y-4">
            ...
            <form onSubmit={handleAddGratitudeSubmit} className="space-y-3 pt-2">
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-slate-850 focus:outline-none focus:border-indigo-500/80 focus:bg-slate-100"
              />
              <button
                type="submit"
